...
<head>
  ...
  <title>I-GEDE - Rekap Gempa</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Navigation Items -->
      <li class="nav-item">
        <a class="nav-link" href="data_gempa.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Data Gempa Terbaru</span></a>
      </li>
      <!-- Navigation Items -->
      <li class="nav-item">
      ...
      <div id="content">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <span class="font-weight-bold">Pengumuman 1</span>
                  </div>
                </a>
              </div>
            </li>
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Rekaman Lengkap Gempa</h6>
          </div>
          <div class="card-body">
...
<?php
        ...
        $query = $conn->prepare( "SELECT * FROM database_utama ORDER BY urutan DESC" );
        $query->execute();
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Rizki Anhar Ramadlan Putra 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
